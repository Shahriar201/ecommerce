                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="img-circle text-center">
                                    <img src="{{ !empty($user->image) ? url('public/upload/user_images/' . $user->image) : url('public/upload/no_image.jpg') }}"
                                        alt="User profile picture" style="height: 130px; weght: 100px" style="border-radius: 5px;">
                                </div>
